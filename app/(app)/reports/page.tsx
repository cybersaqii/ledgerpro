...
const reports = [
  ...
  { href: "/reports/profit-loss", icon: TrendingUp, title: "Profit & loss", text: "Sales, costs, expenses and net profit for any period." },
  { href: "/reports/balance-sheet", icon: Landmark, title: "Balance sheet", text: "Assets, liabilities and equity — your business net worth." },
  { href: "/reports/party-ledger", icon: BookOpen, title: "Party ledger", text: "Full transaction history of any customer or supplier." },
  { href: "/reports/receivables", icon: ArrowDownToLine, title: "Receivables", text: "Who owes you money, and how much." },
  { href: "/reports/payables", icon: ArrowUpFromLine, title: "Payables", text: "Who you owe money to, and how much." },
  { href: "/stock", icon: Boxes, title: "Stock report", text: "Quantities, average cost and value of every product." },
];
